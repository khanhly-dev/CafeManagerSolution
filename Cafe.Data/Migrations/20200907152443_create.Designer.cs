...
namespace Cafe.Data.Migrations
{
    ...
    [Migration("20200907152443_create")]
            ...
            modelBuilder.Entity("Cafe.Data.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0356751687",
                            Adress = "lamdien",
                            DOB = new DateTime(2020, 9, 7, 22, 24, 43, 67, DateTimeKind.Local).AddTicks(3068),
                            Name = "leduykhanh",
                        ...
                        new
                        {
                            Id = "0866162243",
                            Adress = "lamdien",
                            DOB = new DateTime(2020, 9, 7, 22, 24, 43, 67, DateTimeKind.Local).AddTicks(8318),
                            Name = "nguyenvana",
            ...
            modelBuilder.Entity("Cafe.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 63, DateTimeKind.Local).AddTicks(7888),
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(535),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
                            Name = "Sg Cafe Milk",
                            Price = 15000,
                        ...
                        {
                            Id = 3,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(587),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
                        ...
                        {
                            Id = 4,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(589),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
                        ...
                        {
                            Id = 5,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(591),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
                        ...
                        {
                            Id = 6,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(592),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
                        ...
                        {
                            Id = 7,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(593),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
                        ...
                        {
                            Id = 8,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(597),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
                        ...
                        {
                            Id = 9,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(599),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
                            Name = "Strawberry(Dâu)",
                            Price = 15000,
                        ...
                        {
                            Id = 10,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(601),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
                        ...
                        {
                            Id = 11,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(602),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
                            Name = "Lychee(Vải)",
                            Price = 15000,
                        ...
                        {
                            Id = 12,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(606),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
                            Name = "Peach(Đào)",
                            Price = 15000,
                        ...
                        {
                            Id = 13,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(609),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
                        ...
                        {
                            Id = 14,
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 65, DateTimeKind.Local).AddTicks(610),
                            DateEdited = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Đồ uống",
            ...
            modelBuilder.Entity("Cafe.Data.Entities.SellBill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 67, DateTimeKind.Local).AddTicks(4834),
                            Discout = 0,
                            OriginalPrice = 15000,
                            TotalPrice = 30000,
                            UserCreated = "admin"
                        ...
                        new
                        {
                            Id = "HDB002",
                            CustomerId = "0356751687",
                            DateCreated = new DateTime(2020, 9, 7, 22, 24, 43, 67, DateTimeKind.Local).AddTicks(6719),
                            Discout = 0,
                            OriginalPrice = 20000,
                            TotalPrice = 20000,
                            UserCreated = "admin"
